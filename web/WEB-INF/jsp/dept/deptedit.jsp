...
<form action="${ctx}/deptsaveOrUpdate.action" id="jobForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="name" value="${dept.name}" id="name" size="20"/></td>
		    		</tr>
			...
			<tr><td align="left" class="fftd"><input type="submit" value="修改" name ="update">&nbsp;&nbsp;<input type="reset" value="取消 "></td></tr>
		  </table>
	</td>
  </tr>
</table>
