    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#cardId").blur(function () {
                $.ajax({
                    type: "POST",
                    url: "${ctx}/getcardid.action", //链接指向地址
                    data: "cardId=" + $("#cardId").val(),  //形成一对key-value，提交对象可以通过request.getParameter("cardId");获得val值
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            <form action="${ctx}/addSaveEmployee.action" id="employeeForm" method="post">
                <!-- 隐藏表单，flag表示添加标记 -->
