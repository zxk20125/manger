		    ...
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${ctx }/documentlist.action">
					<input type="hidden" name="pageNow" value="${pb.pageNow}" id="pageIndex">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
			...
			<c:forEach items="${pb.list}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${ctx }/updateDocument?id=${document.id}">
							<img title="修改" src="${ctx }/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;"><a href="${ctx }/downloadDocument?id=${document.id}" id="down_${document.id }">
