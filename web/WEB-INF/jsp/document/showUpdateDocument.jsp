...
<%@ page import="com.gec.bean.Document" %>
...
<table width="100%" height="90%" border="0" cellpadding="10" cellspacing="0" class="main_tabbor">
    <tr valign="top">
        <td>
            ...
            <form id="documentForm" name="documentForm" action="${ctx }/UpdatesaveDocument.action"
                   method="post">
                <!-- 隐藏表单，flag表示添加标记 -->
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    ...
                    <tr>
                        <td class="font3 fftd">文档描述：<br/>
                            <textarea name="remark" cols="20" rows="5" id="content">
								<%
                                    Document doc = (Document) request.getAttribute("document");
                                    out.print(doc.getRemark());
                                %>
							</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td class="font3 fftd">文档预览：<br/>
                            <textarea name="file" cols="88" rows="11" id="content1">
								<%
                                    doc = (Document) request.getAttribute("document");
                                    out.println(new String(doc.getFileBytes()));
                                %>
							</textarea>
                        </td>
                    </tr>
